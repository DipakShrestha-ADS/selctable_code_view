...
class CPPSyntaxHighlighter extends LanguageBase {
  CPPSyntaxHighlighter([this.languageTheme]) {
    _spans = <HighlightSpan>[];
    languageTheme ??= LanguageTheme.dracula();
  }

  @override
  Language get type => Language.CPP;

  @override
  LanguageTheme? languageTheme;

  static const List<String> _keywords = const <String>['include', 'alignas', 'alignof', 'and', 'and_eq', 'asm', 'atomic_cancel', 'atomic_commit', 'atomic_noexcept', 'auto', 'bitand', 'bitor', 'break', 'case', 'catch', 'class', 'compl', 'concept', 'const', 'consteval', 'constexpr', 'constini', 'const_cast', 'continue', 'co_await', 'co_return', 'co_yield', 'decltype', 'default', 'delete', 'delete[]', 'do', 'dynamic_cast', 'else', 'enum', 'explicit', 'export', 'extern', 'false', 'for', 'friend', 'goto', 'if', 'inline', 'mutable', 'namespace', 'new', 'noexcept', 'not', 'not_eq', 'nullptr', 'operator', 'or', 'or_eq', 'private', 'protected', 'public', 'reflexpr', 'register', 'reinterpret_cast', 'requires', 'return', 'signed', 'sizeof', 'static', 'static_assert', 'static_cast', 'struct', 'switch', 'synchronized', 'template', 'this', 'thread_local', 'throw', 'true', 'try', 'typedef', 'typeid', 'typename', 'union', 'using', 'virtual', 'volatile', 'while', 'xor', 'xor_eq', 'void'];
    ...
    if (_generateSpans()) {
      ...
      for (HighlightSpan span in _spans) {
        ...
        formattedText.add(TextSpan(
          style: span.textStyle(languageTheme),
  ...
  bool _generateSpans() {
    ...
    while (!_scanner.isDone) {
      ...
      if (_scanner.scan(RegExp(r'(#ifdef)|(#ifndef)|(#if)|(#else)|(#elif)|(#endif)|(#pragma)'))) {
