...
class YamlSyntaxHighlighter extends LanguageBase {
  YamlSyntaxHighlighter([this.languageTheme]) {
  ...
  @override
  Language get type => Language.YAML;
  ...
  bool _generateSpans() {
    ...
    while (!_scanner.isDone) {
      ...
      if (_scanner.scan(RegExp(r'\w+'))) {
        ...
        if (wordEndIndex + 1 < _src.length && (_src.substring(wordEndIndex, wordEndIndex + 1) == ':' || _src.substring(wordEndIndex, wordEndIndex + 1) == '-') && !noKeywords.contains(word)) {
