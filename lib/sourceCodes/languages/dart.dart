...
class DartSyntaxHighlighter extends LanguageBase {
  DartSyntaxHighlighter([this.languageTheme]) {
    _spans = <HighlightSpan>[];
    languageTheme ??= LanguageTheme.dracula();
  }

  @override
  Language get type => Language.DART;

  @override
  LanguageTheme? languageTheme;

  static const List<String> _keywords = const <String>['abstract', 'as', 'assert', 'async', 'await', 'break', 'case', 'catch', 'class', 'const', 'late', 'required', 'continue', 'default', 'deferred', 'do', 'dynamic', 'else', 'enum', 'export', 'external', 'extends', 'factory', 'false', 'final', 'finally', 'for', 'get', 'if', 'implements', 'import', 'in', 'is', 'library', 'new', 'null', 'operator', 'part', 'rethrow', 'return', 'set', 'static', 'super', 'switch', 'sync', 'this', 'throw', 'true', 'try', 'typedef', 'var', 'void', 'while', 'with', 'yield', 'show'];
