...
class JavaScriptSyntaxHighlighter extends LanguageBase {
  JavaScriptSyntaxHighlighter([this.languageTheme]) {
    _spans = <HighlightSpan>[];
    languageTheme ??= LanguageTheme.dracula();
  }

  @override
  Language get type => Language.JAVASCRIPT;

  @override
  LanguageTheme? languageTheme;

  static const List<String> _keywords = const <String>['break', 'debugger', 'export', 'finally', 'in', 'let', 'null', 'public', 'super', 'try', 'arguments', 'byte', 'class', 'default', 'else', 'extends', 'if', 'instanceof', 'package', 'return', 'switch', 'typeof', 'while', 'await', 'case', 'delete', 'enum', 'false', 'implements', 'private', 'with', 'catch', 'continue', 'do', 'eval', 'function', 'import', 'interface', 'new', 'protected', 'static', 'this', 'true', 'void', 'yield'];

  static const List<String> _builtInTypes = const <String>['let', 'var', 'const'];
