...
class SwiftSyntaxHighlighter extends LanguageBase {
  SwiftSyntaxHighlighter([this.languageTheme]) {
    _spans = <HighlightSpan>[];
    languageTheme ??= LanguageTheme.dracula();
  }

  @override
  Language get type => Language.SWIFT;
  ...
  static const List<String> _builtInTypes = const <String>['Int', 'Int8', 'UInt', 'Float', 'Double', 'Bool', 'String', 'Character'];
